...
@section('content')
                        ...
                        <div
                            ...
                            <div class="flex flex-col gap-[2px]">
                                ...
                                <p class="text-sm text-ngekos-grey">
                                    {{ $category->boardingHouses->count() }} Kos
                                </p>
                            </div>
                        </div>
                    </a>
    ...
    <section id="Popular" class="flex flex-col gap-4">
        ...
        <div class="swiper w-full overflow-x-hidden">
            <div class="swiper-wrapper">
                @foreach ($popularBoardingHouses as $popular)
                            ...
                            <div
                                ...
                                <div class="flex flex-col gap-3">
                                    ...
                                    <p class="font-semibold text-lg text-ngekos-orange">
                                        Rp{{ number_format($popular->price, 0, ',', '.') }}<span
                                            class="text-sm text-ngekos-grey font-normal">/bulan</span>
                                    </p>
                                </div>
                            </div>
                        </a>
                ...
                <a href="details.html" class="card">
                    <div
                        ...
                        <div class="flex w-[120px] h-[183px] shrink-0 rounded-[30px] bg-[#D9D9D9] overflow-hidden">
                            <img src="{{ asset('storage/' . $popular->thumbnail) }}" class="w-full h-full object-cover"
                                alt="icon" />
                        </div>
