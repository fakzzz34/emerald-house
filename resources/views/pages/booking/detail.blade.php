                ...
                <div class="flex flex-col gap-3 w-full">
                    ...
                    <div class="flex items-center gap-[6px]">
                        <img src="{{ asset('assets/images/icons/3dcube.svg') }}" class="w-5 h-5 flex shrink-0"
                            alt="icon">
                        <p class="text-sm text-ngekos-grey">{{ $transaction->room->square_feet }} m²</p>
                    </div>
                    <hr class="border-[#F1F2F6]">
                    <p class="font-semibold text-lg text-ngekos-orange">
                        Rp{{ number_format($transaction->room->price_per_month, 0, ',', '.') }}<span
        ...
        <div class="flex flex-col gap-4 pt-[22px]">
            ...
            <div class="flex items-center justify-between">
                ...
                <p class="font-semibold">
                    {{ \Carbon\Carbon::parse($transaction->start_date)->addMonth(intVal($transaction->duration))->isoFormat('D MMMM YYYY') }}
        ...
        <div class="flex flex-col gap-4 pt-[22px]">
            ...
            @if ($transaction->payment_status === 'pending')
                <div class="flex items-center justify-between">
                    ...
                    <p class="rounded-full p-[6px_12px] bg-ngekos-orange font-bold text-xs text-white leading-[18px]">
                        PENDING</p>
                </div>
            @else
                <div class="flex items-center justify-between">
                    ...
                    <p class="rounded-full p-[6px_12px] bg-[#91BF77] font-bold text-xs text-white leading-[18px]">
                        SUCCESSFUL</p>
                </div>
            @endif
        </div>
